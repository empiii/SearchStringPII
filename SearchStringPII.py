...
class BurpExtender(IBurpExtender, IScannerCheck, ITab):
    ...
    def registerExtenderCallbacks(self, callbacks):
        ...
        callbacks.setExtensionName("Search String PII")
        ...
        print("Search PII in Requst/Reposne load")
    ...
    def _initUI(self):
        ...
        info_label = JLabel("Adicione as palavras de cunho sensivel:")
        gbc.gridx = 0
        gbc.gridy = 0
        gbc.gridwidth = 3
